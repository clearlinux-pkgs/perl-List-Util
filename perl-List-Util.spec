...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Scalar-List-Utils-1.68.tar.gz
...
%prep
%setup -q -n Scalar-List-Utils-1.68
cd %{_builddir}/Scalar-List-Utils-1.68
